...
const {
  ...
  image = '',
} = defineProps<OgImageContentProps>()

const formattedTitle = computed(() =>
  title.length > 70 ? `${title.slice(0, 60)}...` : title,
)
const formattedDescription = computed(() =>
  description.length > 110 ? `${description}...` : description,
)
</script>
...
<template>
  <div class="w-full h-full flex flex-col justify-center bg-neutral-900">
    ...
    <div class="w-[600px] pl-[100px]">
      ...
      <p class="text-[40px] text-[#E4E4E7] leading-tight">
    ...
    <div
      v-if="image"
      class="absolute top-[200px] right-[70px]"
    >
      <NuxtImg
        :src="image"
        :alt="title"
